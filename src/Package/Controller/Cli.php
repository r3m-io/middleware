...
namespace Package\R3m\Io\Middleware\Controller;
...
class Cli extends Controller {
    ...
    const INFO = [
        '{{binary()}} r3m_io/middleware              | Middleware options',
        '{{binary()}} r3m_io/middleware setup        | Middleware setup',
        '{{binary()}} r3m_io/middleware update       | Middleware update',
    ];
